 ...
 * 
 * Usage: 
 *   node scripts/seedVehicles.js              # Default: 10,000 vehicles
 *   node scripts/seedVehicles.js 50000        # 50,000 vehicles
 *   node scripts/seedVehicles.js 1000000     # 1 million vehicles
 * 
 * Requires: SUPABASE_URL and SUPABASE_SERVICE_KEY (or SUPABASE_ANON_KEY) in .env
 * Run migrations/add_vehicle_images.sql first
 */

// Load .env from demo folder if dotenv available
try {
